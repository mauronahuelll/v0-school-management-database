  ...
  return (
    <AppShell schoolName="Sequency" userName="Administrador" userRole="ADMIN">
      <div className="space-y-6">
        {/* Header */}
        <header>
          <h1 className="text-display-sm text-foreground">Gestion de Cursos</h1>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-headline-sm text-foreground">{curso.name}</h3>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex items-center gap-2 text-body-sm text-muted-foreground">
                    ...
                    <span className="text-label-caps text-primary">{curso.level}</span>
                  </div>
                </div>
              </div>
            </div>
